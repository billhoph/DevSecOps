...
import { faFacebook, faLinkedin, faMastodon, faReddit, faSlack, faTwitter } from '@fortawesome/free-brands-svg-icons'
...
library.add(faFacebook, faTwitter, faSlack, faReddit, faNewspaper, faStar, fasStar, faPalette, faMastodon, faBold, faLinkedin)
    ...
    this.configurationService.getApplicationConfiguration()
      .pipe(
        ...
        if (config?.application?.social) {
          ...
          if (config.application.social.linkedInUrl) {
            this.linkedInUrl = config.application.social.linkedInUrl
          }
